...
public enum SuccessCode implements ApiCode {
    ...
    SUCCESS_APPROVE_BUSINESS_MEMBER(HttpStatus.OK, "성공적으로 비즈니스 멤버를 승인했습니다."),
    /**
     * home
     * */
    ...
    SUCCESS_DELETE_MAGAZINE(HttpStatus.OK, "매거진을 성공적으로 삭제했습니다."),
    ...
    SUCCESS_GET_SEARCH_EVENT_LIST(HttpStatus.OK, "이벤트 검색을 성공적으로 했습니다."),
    EVENT_SEARCH_SUCCESS(HttpStatus.OK, "이벤트 검색을 성공적으로 했습니다."),
    ...
    GET_USER_POST_LIST(HttpStatus.OK, "사용자가 작성한 포스트 목록을 성공적으로 조회했습니다."),
    SUCCESS_DELETE_POST(HttpStatus.OK, "포스트를 삭제했습니다."),
    ...
    SUCCESS_SEND_NOTIFICATION(HttpStatus.OK, "성공적으로 알림을 전송했습니다."),
