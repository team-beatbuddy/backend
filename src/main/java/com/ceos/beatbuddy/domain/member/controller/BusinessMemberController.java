...
public class BusinessMemberController implements BusinessMemberApiDocs{
    ...
    public ResponseEntity<ResponseDTO<VerificationCodeResponseDTO>> verifyPhoneNumber(@Valid @RequestBody VerifyPhoneNumberDTO dto) {
    ...
    @Override
    @PostMapping("/verify")
    public ResponseEntity<ResponseDTO<BusinessMemberResponseDTO>> verifyBusinessMember(@Valid @RequestBody BusinessMemberDTO dto) {
